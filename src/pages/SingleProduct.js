                  ...
                  <Row className="information__shipping">
                    ...
                    <Col xs={12} sm={8} className="information__text ">
                      <p className="secondary-text">
                        ...
                        a.Parturient in parturient scelerisque nibh lectus quam
                        a natoque adipiscing a vestibulum hendrerit et pharetra
                        fames.Consequat netus.
                        <br />
                        <br />
                        Scelerisque adipiscing bibendum sem vestibulum et in a a
                        a purus lectus faucibus lobortis tincidunt purus lectus
                        nisl class eros.Condimentum a et ullamcorper dictumst
                        mus et tristique elementum nam inceptos hac vestibulum
                        amet elit
                      </p>
                    </Col>
                  </Row>
